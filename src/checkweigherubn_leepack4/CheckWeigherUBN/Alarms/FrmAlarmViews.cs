  ...
  public partial class FrmAlarmViews : Form
  {
    ...
    private void btLoad_Click(object sender, EventArgs e)
    {
      try
      {
        ...
        DateTime dt = Convert.ToDateTime(dateTimePicker3.Text);
        eShift shift = (eShift)(cbShift.SelectedIndex);
        this.errorLog1.DisplayAlarmToListView(dt, shift, _configuration.TemplatePath, _configuration.DatabasePath, _configuration);
    ...
    private bool _is_alarm_export_ok = false;
      ...
      try
      {
        DateTime dt = Convert.ToDateTime(dateTimePicker3.Text);
        eShift shift = (eShift)(cbShift.SelectedIndex);
        _list_alarms = this.errorLog1.DisplayAlarmToListView(dt, shift, _configuration.TemplatePath, _configuration.DatabasePath, _configuration);
        //
