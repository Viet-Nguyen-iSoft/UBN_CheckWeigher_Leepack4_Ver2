...
namespace CheckWeigherUBN
{
  public class ConfigurationTypes : BaseObject, ICloneable
  {
    ...
    public List<AlarmContent> list_AlarmContent = new List<AlarmContent>();
    ...
    public static Dictionary<String, eSQLiteDatabaseDataType> GetDictionaryDB()
    {
      ...
      dictionaryDB.Add(ConfigurationTypes.eConfiguration.IDcounterAlarm.ToString(), eSQLiteDatabaseDataType.INTEGER);
      //
      return dictionaryDB;
    }
    ...
    public override Dictionary<String, String> BuildDictionaryWithValue()
    {
      ...
      Dictionary.Add(ConfigurationTypes.eConfiguration.IDcounterAlarm.ToString(), IDcounterAlarm.ToString());
      return Dictionary;
    }
    ...
    public bool checkDifferent(ConfigurationTypes dst)
    {
      ...
      ret |= (IDcounterAlarm != dst.IDcounterAlarm);
      //
      return ret;
    }
  }
