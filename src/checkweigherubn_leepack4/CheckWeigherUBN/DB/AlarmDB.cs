...
namespace CheckWeigherUBN
{
  public class AlarmDB : DatabaseBaseObject
  {
    ...
    {
      var ValueCode = GetData(r, AlarmType.eAlarm.AlarmCode);
      AlarmType dataRet = new AlarmType()
      {
        ...
        ValueCode = string_to_int(GetData(r, AlarmType.eAlarm.ValueCode)),
        AlarmCode = GetData(r, AlarmType.eAlarm.AlarmCode),
        Description = (GetData(r, AlarmType.eAlarm.Description)),
        Solve = (GetData(r, AlarmType.eAlarm.Solve))
      };
      return dataRet;
    }
