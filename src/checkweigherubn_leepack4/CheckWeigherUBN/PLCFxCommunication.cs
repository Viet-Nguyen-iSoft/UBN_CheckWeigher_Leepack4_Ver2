...
namespace CheckWeigherUBN
{
  ...
  public class PLC_MachineData
  {
    ...
    //Add byViet
    public PLC_MachineDataWithAddress Buffer_Counter = new PLC_MachineDataWithAddress(850, 2);
    //10 buffer Alarm
    public PLC_MachineDataWithAddress PLC_Warning_Buffer1 = new PLC_MachineDataWithAddress(840, 1);
    public PLC_MachineDataWithAddress PLC_Warning_Buffer2 = new PLC_MachineDataWithAddress(841, 1);
    public PLC_MachineDataWithAddress PLC_Warning_Buffer3 = new PLC_MachineDataWithAddress(842, 1);
    public PLC_MachineDataWithAddress PLC_Warning_Buffer4 = new PLC_MachineDataWithAddress(843, 1);
    public PLC_MachineDataWithAddress PLC_Warning_Buffer5 = new PLC_MachineDataWithAddress(844, 1);
    public PLC_MachineDataWithAddress PLC_Warning_Buffer6 = new PLC_MachineDataWithAddress(845, 1);
    public PLC_MachineDataWithAddress PLC_Warning_Buffer7 = new PLC_MachineDataWithAddress(846, 1);
    public PLC_MachineDataWithAddress PLC_Warning_Buffer8 = new PLC_MachineDataWithAddress(847, 1);
    public PLC_MachineDataWithAddress PLC_Warning_Buffer9 = new PLC_MachineDataWithAddress(848, 1);
    public PLC_MachineDataWithAddress PLC_Warning_Buffer10 = new PLC_MachineDataWithAddress(849, 1);

    //10 buffer Error
    public PLC_MachineDataWithAddress PLC_Error_Buffer1 = new PLC_MachineDataWithAddress(830, 1);
    public PLC_MachineDataWithAddress PLC_Error_Buffer2 = new PLC_MachineDataWithAddress(831, 1);
    public PLC_MachineDataWithAddress PLC_Error_Buffer3 = new PLC_MachineDataWithAddress(832, 1);
    public PLC_MachineDataWithAddress PLC_Error_Buffer4 = new PLC_MachineDataWithAddress(833, 1);
    public PLC_MachineDataWithAddress PLC_Error_Buffer5 = new PLC_MachineDataWithAddress(834, 1);
    public PLC_MachineDataWithAddress PLC_Error_Buffer6 = new PLC_MachineDataWithAddress(835, 1);
    public PLC_MachineDataWithAddress PLC_Error_Buffer7 = new PLC_MachineDataWithAddress(836, 1);
    public PLC_MachineDataWithAddress PLC_Error_Buffer8 = new PLC_MachineDataWithAddress(837, 1);
    public PLC_MachineDataWithAddress PLC_Error_Buffer9 = new PLC_MachineDataWithAddress(838, 1);
    public PLC_MachineDataWithAddress PLC_Error_Buffer10 = new PLC_MachineDataWithAddress(839, 1);
    ...
    public PLC_MachineData(int start_address)
    {
      ...
      //counter_Check
      SettingData(start_address, Buffer_Counter);
      //error list
      SettingData(start_address, PLC_Error_Buffer1);
      SettingData(start_address, PLC_Error_Buffer2);
      SettingData(start_address, PLC_Error_Buffer3);
      SettingData(start_address, PLC_Error_Buffer4);
      SettingData(start_address, PLC_Error_Buffer5);
      SettingData(start_address, PLC_Error_Buffer6);
      SettingData(start_address, PLC_Error_Buffer7);
      SettingData(start_address, PLC_Error_Buffer8);
      SettingData(start_address, PLC_Error_Buffer9);
      SettingData(start_address, PLC_Error_Buffer10);
      //warning
      SettingData(start_address, PLC_Warning_Buffer1);
      SettingData(start_address, PLC_Warning_Buffer2);
      SettingData(start_address, PLC_Warning_Buffer3);
      SettingData(start_address, PLC_Warning_Buffer4);
      SettingData(start_address, PLC_Warning_Buffer5);
      SettingData(start_address, PLC_Warning_Buffer6);
      SettingData(start_address, PLC_Warning_Buffer7);
      SettingData(start_address, PLC_Warning_Buffer8);
      SettingData(start_address, PLC_Warning_Buffer9);
      SettingData(start_address, PLC_Warning_Buffer10);
    }
    ...
    public void ApplyFromRawData(PLCFx5U_RawData rawData)
    {
      ...
      { 
        ...
        //buffer counter
        else if (PLCdata.address == Buffer_Counter.adressAsInt)
        {
          this.Buffer_Counter.value = GetData(rawData, i, Buffer_Counter);
        }

        //Erorr buffer 
        else if (PLCdata.address == PLC_Error_Buffer1.adressAsInt)
        {
          this.PLC_Error_Buffer1.value = GetData(rawData, i, PLC_Error_Buffer1);
        }
        else if (PLCdata.address == PLC_Error_Buffer2.adressAsInt)
        {
          this.PLC_Error_Buffer2.value = GetData(rawData, i, PLC_Error_Buffer2);
        }
        else if (PLCdata.address == PLC_Error_Buffer3.adressAsInt)
        {
          this.PLC_Error_Buffer3.value = GetData(rawData, i, PLC_Error_Buffer3);
        }
        else if (PLCdata.address == PLC_Error_Buffer4.adressAsInt)
        {
          this.PLC_Error_Buffer4.value = GetData(rawData, i, PLC_Error_Buffer4);
        }
        else if (PLCdata.address == PLC_Error_Buffer5.adressAsInt)
        {
          this.PLC_Error_Buffer5.value = GetData(rawData, i, PLC_Error_Buffer5);
        }
        else if (PLCdata.address == PLC_Error_Buffer6.adressAsInt)
        {
          this.PLC_Error_Buffer6.value = GetData(rawData, i, PLC_Error_Buffer6);
        }
        else if (PLCdata.address == PLC_Error_Buffer7.adressAsInt)
        {
          this.PLC_Error_Buffer7.value = GetData(rawData, i, PLC_Error_Buffer7);
        }
        else if (PLCdata.address == PLC_Error_Buffer8.adressAsInt)
        {
          this.PLC_Error_Buffer8.value = GetData(rawData, i, PLC_Error_Buffer8);
        }
        else if (PLCdata.address == PLC_Error_Buffer9.adressAsInt)
        {
          this.PLC_Error_Buffer9.value = GetData(rawData, i, PLC_Error_Buffer9);
        }
        else if (PLCdata.address == PLC_Error_Buffer10.adressAsInt)
        {
          this.PLC_Error_Buffer10.value = GetData(rawData, i, PLC_Error_Buffer10);
        }

        //Warning buffer 
        else if (PLCdata.address == PLC_Warning_Buffer1.adressAsInt)
        {
          this.PLC_Warning_Buffer1.value = GetData(rawData, i, PLC_Warning_Buffer1);
        }
        else if (PLCdata.address == PLC_Warning_Buffer2.adressAsInt)
        {
          this.PLC_Warning_Buffer2.value = GetData(rawData, i, PLC_Warning_Buffer2);
        }
        else if (PLCdata.address == PLC_Warning_Buffer3.adressAsInt)
        {
          this.PLC_Warning_Buffer3.value = GetData(rawData, i, PLC_Warning_Buffer3);
        }
        else if (PLCdata.address == PLC_Warning_Buffer4.adressAsInt)
        {
          this.PLC_Warning_Buffer4.value = GetData(rawData, i, PLC_Warning_Buffer4);
        }
        else if (PLCdata.address == PLC_Warning_Buffer5.adressAsInt)
        {
          this.PLC_Warning_Buffer5.value = GetData(rawData, i, PLC_Warning_Buffer5);
        }
        else if (PLCdata.address == PLC_Warning_Buffer6.adressAsInt)
        {
          this.PLC_Warning_Buffer6.value = GetData(rawData, i, PLC_Warning_Buffer6);
        }
        else if (PLCdata.address == PLC_Warning_Buffer7.adressAsInt)
        {
          this.PLC_Warning_Buffer7.value = GetData(rawData, i, PLC_Warning_Buffer7);
        }
        else if (PLCdata.address == PLC_Warning_Buffer8.adressAsInt)
        {
          this.PLC_Warning_Buffer8.value = GetData(rawData, i, PLC_Warning_Buffer8);
        }
        else if (PLCdata.address == PLC_Warning_Buffer9.adressAsInt)
        {
          this.PLC_Warning_Buffer9.value = GetData(rawData, i, PLC_Warning_Buffer9);
        }
        else if (PLCdata.address == PLC_Warning_Buffer10.adressAsInt)
        {
          this.PLC_Warning_Buffer10.value = GetData(rawData, i, PLC_Warning_Buffer10);
        }
